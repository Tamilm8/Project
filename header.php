...
.dropdown1:hover .dropdown-content1 {
  ...
  <!-- Header --> 
                <div class="container-fluid">   
                    ...
                    <div class="dropdown1 header-wrap clearfix">
                        <div class="logo-wrap">
                            <div id="logo" class="dropbtn1 logo">
                                    ...
                                    <ul class="menu"> 
                                        ...
                                        <li><a href="about.php">About</a>
                                            <ul class="submenu list-style">
                                                ...
                                                <li><a href="iso.php">ISO 27001 Information Security Certification</a></li>
                                                <li><a href="whyredsalute.php">Why Red Salute</a></li>
                                        ...
                                        <li><a href="service.php">Services</a>
                                            <ul class="submenu list-style"> 
                                                ...
                                                <li><a href="customersupport.php">Customer support outsourcing
</a></li>
